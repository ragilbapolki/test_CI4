...
class UnitController extends BaseController
{
	...
	public function get_data()
	{
		if ($this->request->isAJAX()) {
			$data = [
				'data_unit' => $this->unit->getDataUnit
				()
			];

			$result = [
				'output' => view('master/unit/view_data', $data)
			];
	...
	public function get_modal()
	{
		if ($this->request->isAJAX()) {
			$result = [
				'output' => view('master/unit/view_modal')
			];
	...
	public function get_modal_edit()
	{
		if ($this->request->isAJAX()) {
			...
			$result = [
				'output' => view('master/unit/view_modal_edit', $data)
			];
