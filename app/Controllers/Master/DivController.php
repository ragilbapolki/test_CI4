...
use App\Models\Master\DivModel;
...
class DivController extends BaseController
{
	...
	public function index()
	{
		...
		return view('master/div/index', $data);
	}
	...
	public function get_data()
	{
		if ($this->request->isAJAX()) {
			...
			$result = [
				'output' => view('master/div/view_data', $data)
			];
	...
	public function get_modal()
	{
		if ($this->request->isAJAX()) {
			$result = [
				'output' => view('master/div/view_modal')
			];
	...
	public function get_modal_edit()
	{
		if ($this->request->isAJAX()) {
			...
			$result = [
				'output' => view('master/div/view_modal_edit', $data)
			];
