...
class CarpApprovalController extends BaseController
{	
	protected $employee;
	protected $category;
	protected $carp;
	...
	{
		$data = [
			'title' => 'Data CARP Approval',
		];

		return view('transaction/carp_approval/index', $data);
	}
	...
	public function get_data()
	{
		if ($this->request->isAJAX()) {
			$data = [
				'data_carp_approval' => $this->carp->getDataCarpApproval()
			];

			$result = [
				'output' => view('transaction/carp_approval/view_data', $data)
			];
	...
	public function get_modal_detail()
	{
		if ($this->request->isAJAX()) {
			...
			$data = [
				...
				'data_progress'	=> $this->carp_progress->getDataProgress($id)
			];

			$result = [
				'output' => view('transaction/carp_approval/view_modal_detail', $data)
			];
