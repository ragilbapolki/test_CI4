...
<div id="layoutSidenav_content">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control select2" id="p_type" title="Select Type">
                                <option value="0">All</option>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            let p_type = null;
            getStock();
            $('#p_product').on('select2:select', function(e) {
                p_product = $(this).val()
                getStock(p_product, p_type);
            })
            ...
            $('.add-modal').click(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?= base_url('transaction/stock/get_modal'); ?>",
                    dataType: "json",
        ...
        getStock = (p_product,p_type) => {
            $.ajax({
                url: "<?= base_url('transaction/stock/get_data') ?>",
                data: { 
                    p_product: p_product,
                    p_type:p_type
                }, 
