 <div class="table-responsive">
     <table class="table table-bordered" id="getCustomer" width="100%" cellspacing="0">
         <thead>
             <tr>
         ...
         <tbody>
             <?php $no = 1;
                foreach ($data_customer as $datas) : ?>
                 <tr>
 ...
 <script>
     $(document).ready(function() {
         $('#getCustomer').DataTable();
     });

     edit = (id) => {
         $.ajax({
             type: "post",
             url: "<?= base_url('master/customer/get_modal_edit'); ?>",
             data: {
                 id: id
             },
             dataType: "json",
     ...
     deletes = (id) => {
         Swal.fire({
             ...
             if (result.value) {
                 $.ajax({
                     type: "post",
                     url: "<?= base_url('master/customer/delete_data'); ?>",
                     data: {
                         id: id
                     },
                     dataType: "json",
