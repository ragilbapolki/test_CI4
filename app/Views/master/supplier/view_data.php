 <div class="table-responsive">
     <table class="table table-bordered" id="getSupplier" width="100%" cellspacing="0">
         <thead>
             <tr>
         ...
         <tbody>
             <?php 
                foreach ($data_supplier as $datas) : ?>
                 <tr>
 ...
 <script>
     $(document).ready(function() {
         $('#getSupplier').DataTable();
     });

     edit = (id) => {
         $.ajax({
             type: "post",
             url: "<?= base_url('master/supplier/get_modal_edit'); ?>",
             data: {
                 id: id
             },
             dataType: "json",
     ...
     deletes = (id) => {
         Swal.fire({
             ...
             if (result.value) {
                 $.ajax({
                     type: "post",
                     url: "<?= base_url('master/supplier/delete_data'); ?>",
                     data: {
                         id: id
                     },
                     dataType: "json",
