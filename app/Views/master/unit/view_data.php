 <div class="table-responsive">
     <table class="table table-bordered" id="getUnit" width="100%" cellspacing="0">
         <thead>
             <tr>
                 <th>Name</th>
                 <th>Description</th>
 ...
 <script>
     ...
     edit = (id) => {
         $.ajax({
             type: "post",
             url: "<?= base_url('master/unit/get_modal_edit'); ?>",
             data: {
                 id: id
             },
             dataType: "json",
     ...
     deletes = (id) => {
         Swal.fire({
             ...
             if (result.value) {
                 $.ajax({
                     type: "post",
                     url: "<?= base_url('master/unit/delete_data'); ?>",
                     data: {
                         id: id
                     },
                     dataType: "json",
