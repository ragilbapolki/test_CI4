 <div class="table-responsive">
     <table class="table table-bordered" id="getDivision" width="100%" cellspacing="0">
         <thead>
             <tr>
                 <th>Name</th>
                 <th>Description</th>
 ...
 <script>
     $(document).ready(function() {
         $('#getDivision').DataTable();
     });

     edit = (id) => {
         $.ajax({
             type: "post",
             url: "<?= base_url('master/division/get_modal_edit'); ?>",
             data: {
                 id: id
             },
             dataType: "json",
     ...
     deletes = (id) => {
         Swal.fire({
             ...
             if (result.value) {
                 $.ajax({
                     type: "post",
                     url: "<?= base_url('master/division/delete_data'); ?>",
                     data: {
                         id: id
                     },
                     dataType: "json",
